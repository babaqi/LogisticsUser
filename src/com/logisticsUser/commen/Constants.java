package com.logisticsUser.commen;
...
public class Constants {
	...
	public static class ServiceInterFace {
		public static String UserLoginUrl = "user/login?jsonuser=";
		public static String UserRegisterUrl = "user/register?jsonuser=";
		...
		public static String RobContextUrl = "context/robOrderInfo?jsoncontext=";
		public static String CityUrl = "city/queryCity?jsonCity=";
	...
	public static class RequestTag {
		...
		public static final int RobContextTag = 1005;
		public static final int UserRegisterTag = 1006;
		public static final int CityTag = 1007;
		public static final int QueryHistoryMenuListTag = 1008;
		public static final int QueryHistoryMenuNumListTag = 1009;
	}
}
